        ...
        <div class="row mb-4">
            <div class="form-group">
                ...
                <p class="text-sm mt-2">
                  In addition to searching by title in the metadata, keywords are also used to search your repository. Please use up to <b>3 keywords</b> that are relevant to your repository.
                </p>
            </div>
        </div>
        {{-- Display Medium ++ only --}}
