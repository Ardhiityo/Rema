<div class="row">
    ...
    @forelse ($this->metrics as $metric)
        <div class="col-6 col-lg-4 col-md-6">
            <div class="card">
                <div class="px-4 card-body py-4-5">
                    <div class="text-center row">
                        ...
                        <div class="text-center text-md-start col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                            <h6 class="font-semibold text-muted">{{ data_get($metric, 'program') }}</h6>
                            <h6 class="mb-0 font-extrabold">{{ data_get($metric, 'total_repositories') }}</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="px-4 card-body py-4-5">
                    <div class="text-center row">
                        ...
                        <div class="text-center text-md-start col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                            <h6 class="font-semibold text-muted">Study Program</h6>
